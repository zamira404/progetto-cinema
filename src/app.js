...
function displayFilms() {
    ...
    if (filmsContainer) {
        films.forEach(function (film) {
            ...
            filmCard.innerHTML = "\n                  <div>\n                      <div>\n                          <img src=\"".concat(film.immagineLocandina, "\" alt=\"").concat(film.titolo, "\" style=\"max-height: 100%; widht:350px; object-fit: cover;\">\n                      </div>\n                      <div>\n                          <div class=\"card-body\">\n                              <h5 class=\"card-title\">").concat(film.titolo, "</h5>\n                              <p class=\"card-text\"><strong>Anno:</strong> ").concat(film.anno, "</p>\n                              <p class=\"card-text\"><strong>Genere:</strong> ").concat(film.genere, "</p>\n                              <p class=\"card-text\"><strong>Regia:</strong> ").concat(film.regia, "</p>\n                              <p class=\"card-text\"><small>Durata: ").concat(film.durata, " min</small></p>\n                              <p class=\"card-text\"><small><strong>Cast:</strong> ").concat(film.cast, "</small></p>\n                          </div>\n                      </div>\n                  </div>\n              ");
